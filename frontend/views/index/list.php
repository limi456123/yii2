	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<?php foreach($childen as $child):?>
					<li>
						<dl>

							<dt><a href="<?=\yii\helpers\Url::to(['index/goods','id'=>$child['id']])?>"><img src="<?=$child['logo']?>" alt="" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['index/goods','id'=>$child['id']])?>"><?=$child['name']?></a></dt>
							<dd><strong>￥<?=$child['shop_price']?></strong></dt>
