		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					...
					?>
					    <div class="cat item1">
						<h3><a href="<?= \yii\helpers\Url::to(['index/list','id'=>$v->id])?>"><?=$v->name?></a> <b></b></h3>
							<div class="cat_detail">
								...
								<dl class="dl_1st">
								<dt><a href="<?= \yii\helpers\Url::to(['index/list','id'=>$i->id])?>"><?=$i->name?></a></dt>
															...
															?>
															<dd>
																<a href="<?= \yii\helpers\Url::to(['index/list','id'=>$j->id])?>"><?=$j->name?></a>
															</dd>
															<?php
															endif;
															endforeach;?>
